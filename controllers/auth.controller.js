...
const createUser = asyncHandler(async (req, res) => {
  ...
  INSERT INTO users (userId, username, email, password, createdAt, updatedAt)
  VALUES (?, ?, ?,?, NOW(), NOW())
`;
  ...
  try {
    ...
    const newUser = [userId, username, email, hashPassword];
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const users = await query(checkQuery, [identifier, identifier]);
